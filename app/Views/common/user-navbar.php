        ...
        <nav class="flex justify-end items-center w-92 h-5 ">
            ...
            <div class="px-4 relative">
                ...
                <div id="dropdownMenu" class="hidden absolute right-0 mt-2 bg-white rounded-md shadow-lg w-fit">
                    <!-- Dropdown menu items -->
                    <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Option 1 test message
                        fkashfaskdjgfaskjdgsadfkashdfgaskjgfaskdfhgaskdjfgfasdfasdfasdfadfasfasdfasdf</a>
            ...
            <div class="relative">
                ...
                <label for="showlinknav" class="cursor-pointer p-2" id="open_menu" onclick="navshowlink();"><?= site_url(session()->get('userRole')); ?>/<?= session()->get('loggedUser'); ?>! <i class="text-sm bi bi-chevron-down"></i>
                </label>
                <ul class="absolute border-2 hidden mt-2 right-0 bg-white rounded-lg shadow-lg p-2 w-40 transition-opacity duration-300 opacity-0"
                    id="dropdown_menu">
                    <li><a href="<?= site_url('profile'); ?>" class="block px-4 py-3 text-lg text-gray-800 hover:bg-gray-200"><i
